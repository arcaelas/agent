...
Only the latest published major version of @arcaelas/agent receives security updates. Older majors are not patched: upgrade to the current release before reporting.

## Reporting a Vulnerability

Report vulnerabilities privately through [GitHub Security Advisories](https://github.com/arcaelas/agent/security/advisories/new). Do not open public issues or pull requests for security problems: that discloses the flaw before a fix exists.
